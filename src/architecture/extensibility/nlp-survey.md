...
| Functionalities extensible  | X | | [Manipulating Pipelines](<https://nlp.johnsnowlabs.com/docs/en/concepts#manipulating-pipelines>) |   |   | `Document` Type     | `Named_Entity` Type     |
